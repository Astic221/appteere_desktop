...
export default function BooksByGenre() {
  ...
  return (
    <div className="">
      ...
      <h1 style={{ fontSize: "1.6rem" }} className="text-xl font-extrabold">Littérature</h1>
      ...
      >
        <CarouselContent>
          {newsBooks.map((item: any, index) => (
            <CarouselItem key={index} className="md:basis-1/3 lg:basis-1/4 sm:basis-1/3 xs:basis-1/2">
              <div className="p-1">
