...
export default function ProfilePage({ params }: { params: Promise<{ editorId: string }> }) {
  ...
  const fetchAuthorData = async () => {
    setLoading(true);
    setError(false);
    await BooksService.getPublisherById(unwrappedParams.editorId, page).then((data) => {
      console.log(data);
      ...
      <div className="relative">
        ...
        <div className="flex items-center" style={{ marginTop: "-80px" }}>
          ...
          <div className="ml-4 mt-8">
            ...
            <p className="text-gray-400">Maison d'édition</p>
          </div>
        </div>
      </div>
