...
export default function NewsBooks() {
  ...
  return (
    <div className="">
      ...
      <h1 style={{ fontSize: "1.6rem" }} className="text-xl font-extrabold">Populaires</h1>
      ...
      <h1 style={{ fontSize: "1.6rem" }} className="mt-12 text-xl font-extrabold">Populaires Classiques</h1>
      ...
      <h1 style={{ fontSize: "1.6rem" }} className="mt-12 text-xl font-extrabold">Populaires Afrique</h1>
      ...
      <h1 style={{ fontSize: "1.6rem" }} className="mt-12 text-xl font-extrabold">Populaires au Sénégal </h1>
