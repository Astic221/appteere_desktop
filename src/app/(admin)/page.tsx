...
export default function Home() {
  ...
  return (
    <div className="">
      ...
      <h1 style={{ fontSize: "1.6rem" }} className="text-xl font-extrabold">Nouveautés</h1>
      ...
      <h1 style={{ fontSize: "1.6rem" }} className="mt-12 text-xl font-extrabold">Recommandations</h1>
      ...
      <h1 style={{ fontSize: "1.6rem" }} className="mt-12 text-xl font-extrabold">Populaires</h1>
      ...
      <PricingSection />
      <h1 style={{ fontSize: "1.6rem" }} className="mt-12 text-xl font-extrabold">À Paraître </h1>
      ...
      <h1 style={{ fontSize: "1.6rem" }} className="mt-12 text-xl font-extrabold">Les Thématiques</h1>
      ...
      <h1 style={{ fontSize: "1.6rem" }} className="mt-12 text-xl font-extrabold">À lire gratuitement</h1>
